 ...
 * Set: VITE_API_URL, VITE_FOUNDER_KEY, VITE_ADMIN_SECRET, VITE_CALENDLY_URL in .env
 */
      ...
      <div style={{padding:20,maxWidth:860,margin:"0 auto"}}>
        ...
        <div style={{padding:"22px 18px",background:`linear-gradient(135deg,${C.accentDim},${C.bg2})`,border:`1px solid ${C.accent}40`,borderRadius:8,marginTop:20,display:"flex",alignItems:"center",gap:20,flexWrap:"wrap"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8,alignItems:"flex-end"}}>
            <button onClick={()=>window.open(CALENDLY_URL,"_blank")} style={{padding:"10px 20px",background:C.accent,color:"#000",border:"none",borderRadius:5,fontSize:12,fontWeight:800,cursor:"pointer",fontFamily:SANS}}>Book 15 Min Audit →</button>
